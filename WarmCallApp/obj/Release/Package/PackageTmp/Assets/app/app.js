...
app.config(['$provide', '$routeProvider', '$httpProvider', function ($provide, $routeProvider, $httpProvider) {
    ...
    $routeProvider.when('/buyerregister', {
        templateUrl: 'App/Register?IsBuyer=true',
        controller: 'registerCtrl'
    });
    $routeProvider.when('buyersignin/:message?', {
        templateUrl: 'App/SignIn?IsBuyer=true',
        controller: 'signInCtrl'
    });
    $routeProvider.when('/sellerregister', {
        templateUrl: 'App/Register?IsBuyer=false',
        controller: 'registerCtrl'
    });
    $routeProvider.when('/sellersignin/:message?', {
        templateUrl: 'App/SignIn?IsBuyer=false',
        controller: 'signInCtrl'
    });
